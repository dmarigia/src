Rectangle {
    ...
    ChartBar {
        ...
        categories: ['Батраков Олександр Олегович', 'Баранюк Христина Олександрівна']
        // ['Фамілія Ім`я По батькові', 'Фамілія Ім`я По батькові', 'Фамілія Ім`я По батькові'] // тоже не надо
        opacity: 0.8

        BarData {
            id: barData1
            values: [0, 1] // это не надо копировать (мы будем values с сервера ТИПА ТЯГАТЬ)
            color: '#B0C5EF'
        ...
        BarData {
            id: barData2
            values: [2, 1] // это не надо копировать
            color: '#D6A7DF'
